...
This section only needs to be read by developers of the **easy-server**
...
project package at https://easy-server.readthedocs.io/
...
Python environment.
Depending on how the `easy-server` package is installed in
...
This section describes how to release a version of **easy-server**
to PyPI.
...
The description assumes that the `andy-maier/easy-server`
Github repo is cloned locally and its upstream repo is assumed to have the Git
remote name `origin`.

Any commands in the following steps are executed in the main directory of your
local clone of the `andy-maier/easy-server`
Git repo.
...
13. On ReadTheDocs, activate the new version ``M.N.U``:
    ...
    * Go to https://readthedocs.org/projects/easy-server/versions/
      and log in.
    ...
    * Activate the new version ``M.N.U``.
      ...
      https://easy-server.readthedocs.io/
...
14. Upload the package to PyPI:
    ...
    **Attention!** This only works once for each version. You cannot release
    ...
    https://pypi.python.org/pypi/easy-server/
...
easy-server project in its Git repo.
